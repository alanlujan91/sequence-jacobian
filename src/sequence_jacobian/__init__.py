...
def agrid(*args, **kwargs):
    warnings.warn(
        "The function 'agrid' is deprecated and will be removed in a subsequent version.\n"
...
def markov_rouwenhorst(*args, **kwargs):
    warnings.warn(
        "Calling sj.markov_rouwenhorst() is deprecated and will be disallowed in a subsequent version.\n"
...
def markov_tauchen(*args, **kwargs):
    warnings.warn(
        "Calling sj.markov_tauchen() is deprecated and will be disallowed in a subsequent version.\n"
...
def interpolate_y(*args, **kwargs):
    warnings.warn(
        "Calling sj.interpolate_y() is deprecated and will be disallowed in a subsequent version.\n"
...
def setmin(*args, **kwargs):
    warnings.warn(
        "Calling sj.setmin() is deprecated and will be disallowed in a subsequent version.\n"
